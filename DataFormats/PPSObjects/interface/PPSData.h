...
class PPSData {
  public:
      ...
      void Fill(int vtxid=-1,double _t=0,double _xi=0,double _p=0,double _pt=0,double _eta=0, double _phi=0,double _th=0,double tof=0,double _ImpPar=0,int st_id=0) {
               NTracks++; momentum.push_back(_p);pT.push_back(_pt);t.push_back(_t);xi.push_back(_xi);eta.push_back(_eta);
               phi.push_back(_phi);theta.push_back(_th);ToF.push_back(tof);RatIP.push_back(_ImpPar);stationId.push_back(st_id);
           };
